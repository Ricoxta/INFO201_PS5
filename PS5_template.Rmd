...
gapminder %>% 
  ...
  mutate(total = (co2 + co2_PC)) %>% 
  ggplot(aes(time, total, col = name)) + 
  geom_line()+
  labs(x = "Time(years)", y = "Total Emissions", col = "Country Name")
...
**I see that Africa had the most amount of growth in avergae life expectancy and that some of the life expectancy decreased from 1960 and 2019 like Asia and Oceania.**
